...
{
    template <class T>
    constexpr TVector4<T> TVector4<T>::zero()
    {
        return { static_cast<T>(0), static_cast<T>(0), static_cast<T>(0), static_cast<T>(0) };
    }

    template <class T>
    constexpr TVector4<T> TVector4<T>::one()
    {
        return { static_cast<T>(1), static_cast<T>(1), static_cast<T>(1), static_cast<T>(1) };
    }

    template <class T>
    constexpr TVector4<T> TVector4<T>::up()
    {
        return { static_cast<T>(0), static_cast<T>(1), static_cast<T>(0), static_cast<T>(0) };
    }

    template <class T>
    constexpr TVector4<T> TVector4<T>::down()
    {
        return { static_cast<T>(0), static_cast<T>(-1), static_cast<T>(0), static_cast<T>(0) };
    }

    template <class T>
    constexpr TVector4<T> TVector4<T>::left()
    {
        return { static_cast<T>(-1), static_cast<T>(0), static_cast<T>(0), static_cast<T>(0) };
    }

    template <class T>
    constexpr TVector4<T> TVector4<T>::right()
    {
        return { static_cast<T>(1), static_cast<T>(0), static_cast<T>(0), static_cast<T>(0) };
    }

    template <class T>
    constexpr TVector4<T> TVector4<T>::front()
    {
        return { static_cast<T>(0), static_cast<T>(0), static_cast<T>(1), static_cast<T>(0) };
    }

    template <class T>
    constexpr TVector4<T> TVector4<T>::back()
    {
        return { static_cast<T>(0), static_cast<T>(0), static_cast<T>(-1), static_cast<T>(0) };
    }

    template <class T>
    constexpr TVector4<T>::TVector4(const T value)
        : TVector4(value, value, value, value)
    {
    }

    template <class T>
    constexpr TVector4<T>::TVector4(const T x, const T y, const T z, const T w)
    ...
    constexpr TVector4<T>::TVector4(const TVector3<U>& other, const W w)
    ...
    template <class T>
    template <class U>
    constexpr TVector4<T>::TVector4(const TVector4<U>& other)
    ...
    template <class T>
    template <class U>
    constexpr TVector4<T>::TVector4(TVector4<U>&& other)
        : TVector4(static_cast<T>(other.m_x), static_cast<T>(other.m_y), static_cast<T>(other.m_z), static_cast<T>(other.m_w))
    {
    }
    ...
    template <class T>
    template <class U>
    constexpr TVector4<T>& TVector4<T>::operator=(const TVector4<U>& other)
    {
    ...
    template <class T>
    template <class U>
    constexpr TVector4<T>& TVector4<T>::operator=(TVector4<U>&& other)
    {
        if (reinterpret_cast<const TVector4*>(&other) == this)
            return *this;
    ...
    template <class T>
    constexpr T& TVector4<T>::operator[](const int index)
    {
        switch (index)
        {
        case 0:
    ...
    template <class T>
    constexpr T TVector4<T>::operator[](const int index) const
    {
        return const_cast<TVector4&>(*this)[index];
    }
    ...
    template <class T>
    template <class U>
    constexpr TVector4<T>& TVector4<T>::operator+=(U value)
    {
    ...
    template <class T>
    template <class U>
    constexpr T TVector4<T>::distanceFrom(const TVector4<U>& other) const
    {
    ...
    template <class T>
    template <class U>
    constexpr T TVector4<T>::distanceSquaredFrom(const TVector4<U>& other) const
    {
    ...
    template <class T>
    template <class U>
    constexpr T TVector4<T>::dot(const TVector4<U>& other) const
    {
    ...
    template <class T>
    template <class U>
    constexpr bool TVector4<T>::isLongerThan(const TVector4<U>& other) const
    {
    ...
    template <class T>
    template <class U>
    constexpr bool TVector4<T>::isShorterThan(const TVector4<U>& other) const
    {
        return other.isLongerThan(*this);
    }

    template <class T>
    constexpr bool TVector4<T>::isUnitVector() const
    {
        return floatEquals<T>(1, this->magnitudeSquared());
    }

    template <class T>
    constexpr T TVector4<T>::magnitude() const
    {
        return squareRoot(this->magnitudeSquared());
    }

    template <class T>
    constexpr T TVector4<T>::magnitudeSquared() const
    {
    ...
    template <class T>
    constexpr void TVector4<T>::scale(const TVector3<T>& other)
    {
        *this *= TVector4(other, 1.f);
    }

    template <class T>
    constexpr void TVector4<T>::translate(const TVector3<T>& other)
    {
    ...
    constexpr bool operator==(const TVector4<T>& left, const TVector4<U>& right)
    {
    ...
    template <class T>
    constexpr TVector4<T> operator-(const TVector4<T>& vector)
    {
        return { -vector.m_x, -vector.m_y, -vector.m_z, -vector.m_w };
    }

    template <class T, class U>
    constexpr TVector4<T> operator+(TVector4<T> left, const TVector4<U>& right)
    {
        return left += right;
    }
    ...
    template <class T, class U>
    constexpr TVector4<T> operator+(TVector4<T> vector, U value)
    {
        return vector += value;
    }
    ...
    template <class T, class U>
    constexpr TVector4<T> operator*(TVector4<T> vector, U scalar)
    {
        return vector *= scalar;
    }

    template <class T, class U>
    constexpr TVector4<U> operator*(U scalar, TVector4<T> vector)
    {
        return vector *= scalar;
    }
