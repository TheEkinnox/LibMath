...
namespace LibMath
{
    ...
    public:
        ...
        constexpr TVector4(const TVector3<U>& other, W w);
         ...
         */
        template <class U>
        constexpr TVector4(const TVector4<U>& other);
         ...
         */
        template <class U>
        constexpr TVector4(TVector4<U>&& other);
         ...
         */
        template <class U>
        constexpr TVector4& operator=(const TVector4<U>& other);
         ...
         */
        template <class U>
        constexpr TVector4& operator=(TVector4<U>&& other);
         ...
         */
        template <class U>
        constexpr TVector4& operator+=(U value);
         ...
         */
        template <class U>
        constexpr T distanceFrom(const TVector4<U>& other) const;
         ...
         */
        template <class U>
        constexpr T distanceSquaredFrom(const TVector4<U>& other) const;
         ...
         */
        template <class U>
        constexpr T dot(const TVector4<U>& other) const;
         ...
         */
        template <class U>
        constexpr bool isLongerThan(const TVector4<U>& other) const;
         ...
         */
        template <class U>
        constexpr bool isShorterThan(const TVector4<U>& other) const;
