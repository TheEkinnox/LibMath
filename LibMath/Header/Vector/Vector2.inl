...
{
    template <class T>
    constexpr TVector2<T> TVector2<T>::zero()
    {
        return { static_cast<T>(0), static_cast<T>(0) };
    }

    template <class T>
    constexpr TVector2<T> TVector2<T>::one()
    {
        return { static_cast<T>(1), static_cast<T>(1) };
    }

    template <class T>
    constexpr TVector2<T> TVector2<T>::up()
    {
        return { static_cast<T>(0), static_cast<T>(1) };
    }

    template <class T>
    constexpr TVector2<T> TVector2<T>::down()
    {
        return { static_cast<T>(0), static_cast<T>(-1) };
    }

    template <class T>
    constexpr TVector2<T> TVector2<T>::left()
    {
        return { static_cast<T>(-1), static_cast<T>(0) };
    }

    template <class T>
    constexpr TVector2<T> TVector2<T>::right()
    {
        return { static_cast<T>(1), static_cast<T>(0) };
    }

    template <class T>
    constexpr TVector2<T>::TVector2(const T value)
        : TVector2(value, value)
    {
    }

    template <class T>
    constexpr TVector2<T>::TVector2(const T x, const T y)
        : m_x(x), m_y(y)
    {
    }
    ...
    template <class T>
    template <class U>
    constexpr TVector2<T>::TVector2(const TVector2<U>& other)
    ...
    template <class T>
    template <class U>
    constexpr TVector2<T>::TVector2(TVector2<U>&& other) noexcept
        : TVector2(static_cast<T>(other.m_x), static_cast<T>(other.m_y))
    {
    }

    template <class T>
    constexpr TVector2<T>::operator TVector3<T>() const
    {
        return { m_x, m_y, 0 };
    }
    ...
    template <class T>
    template <class U>
    constexpr TVector2<T>& TVector2<T>::operator=(const TVector2<U>& other)
    {
    ...
    template <class T>
    template <class U>
    constexpr TVector2<T>& TVector2<T>::operator=(TVector2<U>&& other) noexcept
    {
        if (reinterpret_cast<const TVector2*>(&other) == this)
            return *this;
    ...
    template <class T>
    constexpr T& TVector2<T>::operator[](const int index)
    {
        switch (index)
        {
        case 0:
    ...
    template <class T>
    constexpr T TVector2<T>::operator[](const int index) const
    {
        return const_cast<TVector2&>(*this)[index];
    }
    ...
    template <class T>
    template <class U>
    constexpr TVector2<T>& TVector2<T>::operator+=(U value)
    {
    ...
    template <class T>
    template <class U>
    constexpr T TVector2<T>::cross(const TVector2<U>& other) const
    {
    ...
    template <class T>
    template <class U>
    constexpr T TVector2<T>::distanceFrom(const TVector2<U>& other) const
    {
    ...
    template <class T>
    template <class U>
    constexpr T TVector2<T>::distanceSquaredFrom(const TVector2<U>& other) const
    {
    ...
    template <class T>
    template <class U>
    constexpr T TVector2<T>::dot(const TVector2<U>& other) const
    {
    ...
    template <class T>
    template <class U>
    constexpr bool TVector2<T>::isLongerThan(const TVector2<U>& other) const
    {
    ...
    template <class T>
    template <class U>
    constexpr bool TVector2<T>::isShorterThan(const TVector2<U>& other) const
    {
        return other.isLongerThan(*this);
    }

    template <class T>
    constexpr bool TVector2<T>::isUnitVector() const
    {
        return floatEquals<T>(1, this->magnitudeSquared());
    }

    template <class T>
    constexpr T TVector2<T>::magnitude() const
    {
        return squareRoot(this->magnitudeSquared());
    }

    template <class T>
    constexpr T TVector2<T>::magnitudeSquared() const
    {
    ...
    void TVector2<T>::rotate(const Radian& angle)
    {
        ...
        const T x = m_x * c - m_y * s;
        const T y = m_x * s + m_y * c;
    ...
    template <class T>
    constexpr void TVector2<T>::scale(const TVector2& other)
    {
        *this *= other;
    }
    ...
    template <class T>
    constexpr void TVector2<T>::translate(const TVector2& other)
    {
        *this += other;
    }

    template <class T, class U>
    constexpr bool operator==(const TVector2<T>& left, const TVector2<U>& right)
    {
    ...
    template <class T>
    constexpr TVector2<T> operator-(const TVector2<T>& vector)
    {
        return vector * -1;
    }

    template <class T, class U>
    constexpr TVector2<T> operator+(TVector2<T> left, const TVector2<U>& right)
    {
        return left += right;
    }
    ...
    template <class T, class U>
    constexpr TVector2<T> operator+(TVector2<T> vector, U value)
    {
        return vector += value;
    }
    ...
    template <class T, class U>
    constexpr TVector2<T> operator*(TVector2<T> vector, U scalar)
    {
        return vector *= scalar;
    }

    template <class T, class U>
    constexpr TVector2<U> operator*(U scalar, TVector2<T> vector)
    {
